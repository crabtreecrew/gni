class CreateNameStringIndices < ActiveRecord::Migration
  def up
    execute "CREATE TABLE `name_string_indices` (
      ...
      `name_string_id` int(11) UNSIGNED DEFAULT NULL,
      `data_source_id` int(11) DEFAULT NULL,
      `created_at` datetime DEFAULT NULL,
      `updated_at` datetime DEFAULT NULL,
      PRIMARY KEY (`id`),
      UNIQUE KEY `idx_name_string_indices_1` (`data_source_id`,`name_string_id`),
      KEY `idx_name_string_indices_2` (`name_string_id`)
